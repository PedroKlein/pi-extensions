...
function mergeDefaults(global: Partial<Defaults> | undefined, local: Partial<Defaults> | undefined): Defaults {
	return {
		...DEFAULT_DEFAULTS,
		...(global ?? {}),
		...(local ?? {}),
...
function mergeApps(globalApps: AppConfig[], localApps: AppConfig[]): AppConfig[] {
